...
letsencrypt_cert_domains:
   - nakuru.openmrs.org
   - ocl-stg.openmrs.org
   - oclapi-stg.openmrs.org

nginx_vhosts:
  - listen: "80 default_server"
    server_name: "ocl-stg.openmrs.org"
    extra_parameters: |
  ...
  - listen: "443 ssl"
    ...
    extra_parameters: |
      ...
      ssl_certificate /etc/letsencrypt/live/nakuru.openmrs.org/fullchain.pem;
      ssl_certificate_key /etc/letsencrypt/live/nakuru.openmrs.org/privkey.pem;
  ...
  - listen: "80"
    server_name: "oclapi-stg.openmrs.org"
    extra_parameters: |
      return 301 https://$host$request_uri;
  - listen: "443 ssl"
    server_name: "oclapi-stg.openmrs.org"
  ...
  - listen: "443 ssl"
    server_name: "nakuru.openmrs.org"
    extra_parameters: |
